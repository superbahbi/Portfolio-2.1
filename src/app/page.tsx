...
export default function Home() {
  return (
    <main className="col-span-6 flex min-w-full flex-row flex-wrap">
      <h1 className="font-mono text-4xl font-semibold tracking-wider text-slate-100">
        <div className="flex flex-row gap-2">
          <Terminal className="h-10 w-10" />
          <TextEncrypted interval={100} text="Robert Kugler" />
        </div>
      </h1>
      <h2 className="gap-2 text-2xl font-medium tracking-wide text-slate-200">
        {`<Full Stack Software Engineer />`}
      </h2>
      <div className="flex flex-col gap-2">
        <p className="tracking-tighter text-slate-200 [text-wrap:balance]">
